...
//make a function maxmin() that finds min and max among the first three parameters.
// the min and max will be the 4th and 5th parameters as the reference variable
#include <iostream>
#include <iomanip>
using namespace std;
...
{
    cout << "Enter your input (3 numbers)\n";
    cin >> num1 >>num2 >> num3;
